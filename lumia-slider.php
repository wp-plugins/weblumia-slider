...
function show_lumiaslider( $args ) {?>
	...
	if( $slider ){
		...
		foreach( $slider as $sliderObj ){
			...
			//if ( preg_match( '%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', stripslashes( $slides['custom_html'] ), $match ) ){
			...
			if ( parse_youtube( stripslashes( $slides['custom_html'] ) ) ){
				...
				$html		.=	'<li><iframe width="128" height="72" src="http://www.youtube.com/embed/' . $video_id . '" frameborder="0" allowfullscreen></iframe></li>';
				...
				$html		.=	'<li><iframe src="http://player.vimeo.com/video/' . $video_id . '?color=ff9933&amp;loop=1" width="128" height="72" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></li>';
...
<div class="wrap">
	...
	<h2><?php _e( 'Lumia Slider Settings', 'lumiaslider' ) ?></h2>

	<?php if( $_REQUEST['settings-updated'] == 'true' ){?>

		<div class="updated below-h2" id="message"><p>Lumia Slider Settings Updated</p></div>
		...
		<div class="wl-pages" >
			...
			<div class="wl-page wl-settings active">
				...
				<div class="wl-box wl-settings">
					...
					<h3 class="header"><?php _e( 'Global Settings', 'lumiaslider' ) ?></h3>
							...
							<thead>
								...
								<tr>
									...
									<td colspan="3">
										...
										<h4><?php _e( 'General', 'lumiaslider' ) ?></h4>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_mode = get_option( 'lumia_mode' ); ?>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_infiniteLoop = get_option( 'lumia_infiniteLoop' ); ?>
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="lumia_speed" id="lumia_speed" size="7" value="<?php echo get_option( 'lumia_speed' ); ?>" class="input" />

									</td>

									 <td class="desc">(ms)<?php _e( ' The slider speed time in milli seconds. ', 'lumiaslider' ) ?></td>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_easing = get_option( 'lumia_easing' ); ?>
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="lumia_start_slide" id="lumia_start_slide" size="7" value="<?php echo get_option( 'lumia_start_slide' ); ?>" class="input" />
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_random_start = get_option( 'lumia_random_start' ); ?>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_captions = get_option( 'lumia_captions' ); ?>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_video = get_option( 'lumia_video' ); ?>
								...
								<tr class="heading">
									...
									<td colspan="3">
										...
										<h4><?php _e( 'Pager', 'lumiaslider' ) ?></h4>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_video = get_option( 'lumia_pager '); ?>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_pagertype = get_option( 'lumia_pagertype '); ?>
								...
								<tr class="heading">
									...
									<td colspan="3">
										...
										<h4><?php _e( 'Controls', 'lumiaslider' ) ?></h4>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_controls = get_option( 'lumia_controls '); ?>
								...
								<tr>
									...
									<td>
										...
										<?php $lumia_auto_controls = get_option( 'lumia_auto_controls '); ?>
								...
								<tr>
									...
									<td><?php _e( 'Automatic', 'lumiaslider' ) ?></td>
										...
										<?php $lumia_auto = get_option( 'lumia_auto' ); ?>
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="lumia_pause" id="lumia_pause" size="7" value="<?php echo get_option( 'lumia_pause' ); ?>" class="input" />

									</td>

									 <td class="desc">(ms)<?php _e( ' The slider pause time in milli seconds. The slide will be delayed for the given milli seconds.', 'lumiaslider' ) ?></td>
...
function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'id' ); ?>"><?php _e('Choose a slider:', 'lumiaslider') ?></label><br>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'lumiaslider'); ?></label>
